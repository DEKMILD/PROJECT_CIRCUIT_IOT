...
const char* ssid = "Mild"; //อย่าลืมแก้ไข SSID ของ WIFI ที่จะให้ NodeMCU ไปเชื่อมต่อ
const char* password = "1234567899"; //อย่าลืมแก้ไข PASSWORD ของ WIFI
const char* mqtt_server = "d2613297421847e9b0f0732cec40fa4d.s1.eu.hivemq.cloud"; //อย่าลืมแก้ไข BROKER
const int mqtt_port = 8884;
//const char* mqtt_Client = "LAB";  //อย่าลืมแก้ไข ClientID
const char* mqtt_username = "ham";  //อย่าลืมแก้ไข Token
const char* mqtt_password = "123456789"; //อย่าลืมแก้ไข Secret
...
void reconnect() {
  ...
  if (client.connect(mqtt_username, mqtt_password)) { //เชื่อมต่อกับ MQTT BROKER
...
void update() {
 ...
 String statusMessage = "{\"status2\": " + String(tableStatus2) + ", \"Numpeople2\": " + String(Numpeople2) + "}";
